...
//              .and().formLogin();
                ...
                .and().formLogin().permitAll().loginProcessingUrl("https://frontendsmartluggage.herokuapp.com/Login")
              .defaultSuccessUrl("https://frontendsmartluggage.herokuapp.com/",true)
